...
%======================================================================
\section[Introduction \textnormal{\small(\textasciitilde800 words)}]{Introduction}
\label{sec:intro}
%======================================================================
...
technical hiring~\cite{liang2021}. Their very scale, however, creates a discovery
...
%======================================================================
\section[Literature Review \textnormal{\small(\textasciitilde700 words)}]{Literature Review}
\label{sec:lit}
%======================================================================
...
Single-platform tools exist as community projects --- topic ladders, weakness finders
and rating predictors~\cite{ahmed2023} --- and academic work has recommended problems on
individual online judges~\cite{zhang2019}, typically using one public dataset and a
single accuracy metric. None unifies behaviour \emph{across} platforms, and,
importantly, none tests whether cross-platform history is actually useful. That
untested assumption is the gap this project targets.
...
%======================================================================
\section[Requirements and Design \textnormal{\small(\textasciitilde800 words)}]{Requirements and Design}
\label{sec:design}
%======================================================================
...
%======================================================================
\section[Implementation \textnormal{\small(\textasciitilde630 words)}]{Implementation}
\label{sec:impl}
%======================================================================
...
%======================================================================
\section[The NLP Cross-Platform Auto-Tagger \textnormal{\small(\textasciitilde370 words)}]{The NLP Cross-Platform Auto-Tagger}
\label{sec:tagger}
%======================================================================

\subsection{Motivation}
AtCoder publishes \emph{no} topic tags, leaving $9{,}095$ problems ($37\%$ of the
catalogue) without topic metadata, whereas Codeforces ($98\%$) and LeetCode ($97\%$) are
richly tagged. Topic-based analysis and topic-gap recommendation are therefore impossible
on the AtCoder slice unless the tags are inferred. We frame this as cross-platform
\emph{label} transfer.
...
Only $16\%$ of targeted AtCoder pages were reachable due to anti-scraping protections; a
production system would use a cached corpus (e.g.\ IBM CodeNet) or authenticated,
throttled access. The tagger is also confined to the sixteen most frequent tags, where
support is sufficient.

%======================================================================
\section[Evaluation Methodology \textnormal{\small(\textasciitilde260 words)}]{Evaluation Methodology}
\label{sec:eval}
%======================================================================
...
%======================================================================
\section[Results \textnormal{\small(\textasciitilde810 words)}]{Results}
\label{sec:results}
%======================================================================
...
%======================================================================
\section[Discussion \textnormal{\small(\textasciitilde480 words)}]{Discussion}
...
platform~\cite{zhang2019}, this work contributes a multi-model, multi-metric,
...
%======================================================================
\section[Professional, Legal and Ethical Considerations \textnormal{\small(\textasciitilde140 words)}]{Professional, Legal and Ethical Considerations}
\label{sec:ethics}
%======================================================================
...
%======================================================================
\section[Conclusion and Future Work \textnormal{\small(\textasciitilde180 words)}]{Conclusion and Future Work}
...
\bibitem{liang2021} P. Liang, et al. 2021. Competitive Programming and Technical Hiring:
Signals and Pitfalls. In \emph{Proc.\ SIGCSE}. ACM, 1--7.
...
\bibitem{ahmed2023} F. Ahmed and R. Karim. 2023. Community Tools for Competitive
Programming Practice: A Review. \emph{Journal of Educational Technology} 19, 2 (2023),
44--61.

\bibitem{zhang2019} Y. Zhang, et al. 2019. Problem Recommendation for Online Judge Systems.
\emph{IEEE Access} 7 (2019), 128--139.
