...
%======================================================================
\section[Implementation \textnormal{\small(1,562 words)}]{Implementation}
\label{sec:impl}
%======================================================================
...
is a finding or a bug, and the project leaned on four habits rather than on a formal test
suite.
...
It should be stated plainly that this is weaker than a unit-test suite. There is no
automated test target, so the guarantees above are procedural rather than enforced, and a
regression would be caught only when a stage was next re-run. For a system of this size
and lifetime that trade was acceptable --- the pipeline is run end-to-end often, which is
the condition under which regenerability substitutes tolerably for testing --- but it is
the first thing that would need to change before the code could be maintained by anyone
else, and it is a fair criticism of the implementation as delivered.
...
%======================================================================
\section[Evaluation Methodology \textnormal{\small(302 words)}]{Evaluation Methodology}
\label{sec:eval}
%======================================================================
