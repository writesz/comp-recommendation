...
%======================================================================
\section[Implementation \textnormal{\small(1,874 words)}]{Implementation}
\label{sec:impl}
%======================================================================
...
\paragraph{Automated tests.} A \texttt{pytest} suite of $119$ tests covers seven areas
...
\texttt{test\_codechef.py} & 28 & Sentinel difficulties rejected rather than normalised
to zero; the taxonomy used as a whitelist so setter usernames are discarded; submission
rows parsed from the cell attribute rather than the intermittent link. \\
