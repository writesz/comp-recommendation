...
%======================================================================
\section[Introduction \textnormal{\small(1,015 words)}]{Introduction}
\label{sec:intro}
%======================================================================
...
%======================================================================
\section[Requirements and Design \textnormal{\small(1,520 words)}]{Requirements and Design}
\label{sec:design}
%======================================================================
...
%======================================================================
\section[Implementation \textnormal{\small(1,898 words)}]{Implementation}
\label{sec:impl}
%======================================================================
...
engine. \\
\texttt{scripts/} & 4{,}122 & 27 pipeline stages: acquisition, dataset construction,
...
awkward case: its official API was withdrawn and now returns \texttt{401}, so the
fetcher uses the same public endpoints that serve the site itself, reading the catalogue
as JSON but reconstructing user histories from the paginated submissions widget, roughly
a dozen HTML rows per request. It also throttles an order of magnitude harder than the
others --- a half-second loop is rejected within about a dozen requests --- so its
client backs off exponentially on \texttt{429} and retries. All fetchers enforce a
